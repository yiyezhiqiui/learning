#include "../include/rm_behavior_tree/rm_behavior_tree.h"

#include "../include/behaviortree_ros2/plugins.hpp"
...
int main(int argc, char ** argv)
{
    ...
    node->declare_parameter<std::string>(
        "style", "./src/rm_behavior_tree/rm_behavior_tree.xml");
    node->get_parameter_or<std::string>(
        "style", bt_xml_path, "./src/rm_behavior_tree/config/attack_left.xml");
